...
int main(void)
{
  ...
  Lcd_cursor(&lcd, 0,1);
  Lcd_string(&lcd, "Nikshitha");
  Lcd_cursor(&lcd, 1, 1);
  Lcd_string(&lcd, "212224040220");
...
<img width="1092" height="762" alt="image" src="https://github.com/user-attachments/assets/985435e9-bc11-4026-b620-4c66dbb00f90" />

 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 
 <img width="1038" height="907" alt="image" src="https://github.com/user-attachments/assets/eb021c7e-7551-4785-bb4e-422c4a85a361" />
